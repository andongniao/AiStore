...
public class FclassMoreAdapter extends BaseAdapter {
	...
	public FclassMoreAdapter(Context context, ArrayList<GoodsBean> list) {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		if (arg1 == null) {
			...
			myItem.tv_shop_price = (TextView) arg1
					.findViewById(R.id.fclass_more_item_shop_price_tv);
